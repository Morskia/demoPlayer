...
<button id="start" style="display: none"><i class="far fa-play-circle"></i></button>
<div id="screen-layout" style="display: block">
    <div id="advertising">
        <video muted id="advertising_player"></video>
    </div>
    <div id="appendPlayer" style="position: absolute; left: 0; top: 0; z-index: 1">
        <?php if (count($videos) > 0) { ?>
            <video playsinline autoplay muted id="player"
