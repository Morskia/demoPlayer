						...
						<div class="card-body p-0">
							...
							<div class="row p-4">
								<div class="col-12 p-3 d-flex flex-column justify-content-center">
									...
									<img style="max-width: 200px" class="img-fluid mb-3 mx-auto" src="<?php echo URL.LOGO; ?>" alt="">
									...
									<form id="loginForm" class="user" method="post" action="<?php echo URL; ?>login/clientLogin">
										<div class="form-group">
											<input id="user_name" type="text" class="bg-dark-gray form-control form-control-user  border-fifth-2" name="user_name" aria-describedby="userName" placeholder="Въведете потребителско име">
										</div>
										<div class="form-group">
											<input id="password" type="password" class="bg-dark-gray form-control form-control-user  border-fifth-2" name="password" placeholder="Въведете парола">
										</div>
										<div class="form-group">
											<input type="hidden" name="player" value="<?php echo $_GET['video'] ?? ''; ?>">
