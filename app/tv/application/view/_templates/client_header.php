...
<body id="page-top" class="position-relative pt-5 mt-5" style="background-image: url(<?php echo  $this->helpers::big( $_SESSION['wallpaper']); ?>)">
<nav class="navbar navbar-expand-lg  fixed-top">
    <div class="cotnainer container p-0 my-0 mx-auto">
        <a class="navbar-brand" href="<?php echo URL; ?>"><img src="<?php echo URL; ?>img/small_logo.png"></a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarsExample09"
                aria-controls="navbarsExample09" aria-expanded="false" aria-label="Toggle navigation">
            <img src="<?php echo URL; ?>img/small_logo.png">
                    ...
                    <?php if (isset($_SESSION['user'])) { ?>
                        <a class="nav-link"
                           href="<?php echo URL; ?>login/logout">   <?php echo $_SESSION['lang'] == 'en' ? 'Hello' : 'Здравей'; ?> <?php echo $_SESSION['user']; ?>
                            ,
                            <?php echo $_SESSION['lang'] == 'en' ? 'Log out' : 'Излез'; ?> </a>
                    <?php } else { ?>
                        <a href="<?php echo URL; ?>login"
                           class="nav-link text-light d-block btn bg-green"><?php echo $this->strings['login']; ?></a>
                    <?php } ?>
                </li>
